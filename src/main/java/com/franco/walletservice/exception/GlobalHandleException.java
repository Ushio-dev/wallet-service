...
public class GlobalHandleException {
    ...
    public ResponseEntity<ErrorDto> manageInsufficientFundsException(InsufficientFundsException ex) {
        ErrorDto error = new ErrorDto(ex.getMessage(), HttpStatus.CONFLICT.value());

        return new ResponseEntity<>(error, HttpStatus.CONFLICT);
    }

    @ExceptionHandler(NotSameCurrencyException.class)
    public ResponseEntity<ErrorDto> manageNotSameCurrencyException(NotSameCurrencyException ex) {
        ErrorDto error = new ErrorDto(ex.getMessage(), HttpStatus.CONFLICT.value());
